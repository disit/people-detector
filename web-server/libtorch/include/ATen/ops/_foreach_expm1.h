...
inline ::std::vector<at::Tensor> _foreach_expm1(at::TensorList tensors) {
...
// aten::_foreach_expm1.functional(Tensor[] self) -> Tensor[] self_out
inline ::std::vector<at::Tensor> _foreach_expm1_functional(at::TensorList self) {
    return at::_ops::_foreach_expm1_functional::call(self);
}
