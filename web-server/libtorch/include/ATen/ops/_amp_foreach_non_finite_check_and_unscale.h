...
inline ::std::tuple<::std::vector<at::Tensor>,at::Tensor> _amp_foreach_non_finite_check_and_unscale_functional(at::TensorList self, const at::Tensor & found_inf, const at::Tensor & inv_scale) {
