...
inline ::std::vector<at::Tensor> _foreach_reciprocal(at::TensorList tensors) {
...
// aten::_foreach_reciprocal.functional(Tensor[] self) -> Tensor[] self_out
inline ::std::vector<at::Tensor> _foreach_reciprocal_functional(at::TensorList self) {
    return at::_ops::_foreach_reciprocal_functional::call(self);
}
