...
inline ::std::vector<at::Tensor> _foreach_log1p(at::TensorList tensors) {
...
// aten::_foreach_log1p.functional(Tensor[] self) -> Tensor[] self_out
inline ::std::vector<at::Tensor> _foreach_log1p_functional(at::TensorList self) {
    return at::_ops::_foreach_log1p_functional::call(self);
}
