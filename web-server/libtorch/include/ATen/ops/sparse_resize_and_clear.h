...
// aten::sparse_resize_and_clear.functional(Tensor self, int[] size, int sparse_dim, int dense_dim) -> Tensor
inline at::Tensor sparse_resize_and_clear_functional(const at::Tensor & self, at::IntArrayRef size, int64_t sparse_dim, int64_t dense_dim) {
    return at::_ops::sparse_resize_and_clear_functional::call(self, size, sparse_dim, dense_dim);
}
