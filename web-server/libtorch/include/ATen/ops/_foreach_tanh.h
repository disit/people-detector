...
inline ::std::vector<at::Tensor> _foreach_tanh(at::TensorList tensors) {
...
// aten::_foreach_tanh.functional(Tensor[] self) -> Tensor[] self_out
inline ::std::vector<at::Tensor> _foreach_tanh_functional(at::TensorList self) {
    return at::_ops::_foreach_tanh_functional::call(self);
}
