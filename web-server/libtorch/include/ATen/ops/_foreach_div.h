...
inline ::std::vector<at::Tensor> _foreach_div(at::TensorList tensors, const at::Scalar & scalar) {
...
inline ::std::vector<at::Tensor> _foreach_div(at::TensorList tensors1, at::TensorList tensors2) {
...
inline ::std::vector<at::Tensor> _foreach_div(at::TensorList tensors, at::ArrayRef<at::Scalar> scalars) {
...
inline ::std::vector<at::Tensor> _foreach_div_functional(at::TensorList self, const at::Scalar & scalar) {
...
inline ::std::vector<at::Tensor> _foreach_div_functional(at::TensorList self, at::TensorList other) {
...
inline ::std::vector<at::Tensor> _foreach_div_functional(at::TensorList self, at::ArrayRef<at::Scalar> scalars) {
