...
inline ::std::vector<at::Tensor> _foreach_sin(at::TensorList tensors) {
...
// aten::_foreach_sin.functional(Tensor[] self) -> Tensor[] self_out
inline ::std::vector<at::Tensor> _foreach_sin_functional(at::TensorList self) {
    return at::_ops::_foreach_sin_functional::call(self);
}
