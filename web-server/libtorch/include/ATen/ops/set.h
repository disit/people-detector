...
inline at::Tensor set_functional(const at::Tensor & self, at::Storage source) {
...
inline at::Tensor set_functional(const at::Tensor & self, at::Storage source, int64_t storage_offset, at::IntArrayRef size, at::IntArrayRef stride={}) {
...
inline at::Tensor set_functional(const at::Tensor & self, const at::Tensor & source) {
...
inline at::Tensor set_functional(const at::Tensor & self) {
