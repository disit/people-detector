...
inline ::std::tuple<at::Tensor,at::Tensor> _amp_update_scale_functional(const at::Tensor & self, const at::Tensor & growth_tracker, const at::Tensor & found_inf, double scale_growth_factor, double scale_backoff_factor, int64_t growth_interval) {
    return at::_ops::_amp_update_scale_functional::call(self, growth_tracker, found_inf, scale_growth_factor, scale_backoff_factor, growth_interval);
}
