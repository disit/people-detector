...
inline ::std::vector<at::Tensor> _foreach_sub(at::TensorList tensors, const at::Scalar & scalar) {
...
inline ::std::vector<at::Tensor> _foreach_sub(at::TensorList tensors1, at::TensorList tensors2, const at::Scalar & alpha=1) {
...
inline ::std::vector<at::Tensor> _foreach_sub(at::TensorList tensors, at::ArrayRef<at::Scalar> scalars) {
...
inline ::std::vector<at::Tensor> _foreach_sub_functional(at::TensorList self, const at::Scalar & scalar) {
...
inline ::std::vector<at::Tensor> _foreach_sub_functional(at::TensorList self, at::TensorList other, const at::Scalar & alpha=1) {
...
inline ::std::vector<at::Tensor> _foreach_sub_functional(at::TensorList self, at::ArrayRef<at::Scalar> scalars) {
