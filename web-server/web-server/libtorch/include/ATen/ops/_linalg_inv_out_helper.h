...
inline ::std::tuple<at::Tensor,at::Tensor,at::Tensor> _linalg_inv_out_helper_functional(const at::Tensor & self, const at::Tensor & infos_lu, const at::Tensor & infos_getri) {
