...
inline ::std::vector<at::Tensor> _foreach_erf(at::TensorList tensors) {
...
// aten::_foreach_erf.functional(Tensor[] self) -> Tensor[] self_out
inline ::std::vector<at::Tensor> _foreach_erf_functional(at::TensorList self) {
    return at::_ops::_foreach_erf_functional::call(self);
}
