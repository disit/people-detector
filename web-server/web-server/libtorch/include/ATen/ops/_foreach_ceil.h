...
inline ::std::vector<at::Tensor> _foreach_ceil(at::TensorList tensors) {
...
// aten::_foreach_ceil.functional(Tensor[] self) -> Tensor[] self_out
inline ::std::vector<at::Tensor> _foreach_ceil_functional(at::TensorList self) {
    return at::_ops::_foreach_ceil_functional::call(self);
}
