...
inline ::std::vector<at::Tensor> _foreach_log(at::TensorList tensors) {
...
// aten::_foreach_log.functional(Tensor[] self) -> Tensor[] self_out
inline ::std::vector<at::Tensor> _foreach_log_functional(at::TensorList self) {
    return at::_ops::_foreach_log_functional::call(self);
}
