...
inline at::Tensor _index_put_impl_functional(const at::Tensor & self, const c10::List<c10::optional<at::Tensor>> & indices, const at::Tensor & values, bool accumulate=false, bool unsafe=false) {
    return at::_ops::_index_put_impl_functional::call(self, indices, values, accumulate, unsafe);
}
