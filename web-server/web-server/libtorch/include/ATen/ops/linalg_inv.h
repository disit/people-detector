...
inline at::Tensor linalg_inv(const at::Tensor & self) {
    return at::_ops::linalg_inv::call(self);
}

// aten::linalg_inv.out(Tensor self, *, Tensor(a!) out) -> Tensor(a!)
inline at::Tensor & linalg_inv_out(at::Tensor & out, const at::Tensor & self) {
    return at::_ops::linalg_inv_out::call(self, out);
}

// aten::linalg_inv.out(Tensor self, *, Tensor(a!) out) -> Tensor(a!)
inline at::Tensor & linalg_inv_outf(const at::Tensor & self, at::Tensor & out) {
    return at::_ops::linalg_inv_out::call(self, out);
}
